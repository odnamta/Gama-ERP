...
export type AttachmentEntityType = 'pjo' | 'jo' | 'invoice' | 'customer' | 'project' | 'pib' | 'peb' | 'quotation' | 'medical_checkup' | 'incident' | 'audit' | 'safety_permit' | 'leave_request' | 'survey' | 'bkk' | 'vendor_invoice';
