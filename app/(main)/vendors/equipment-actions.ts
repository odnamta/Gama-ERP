...
export async function getVendorEquipment(vendorId: string): Promise<{
  ...
  return { data: (data ?? []).map(e => ({ ...e, equipment_type: e.equipment_type as EquipmentType, condition: e.condition as EquipmentCondition })) as VendorEquipment[] };
}
...
export async function getEquipmentById(id: string): Promise<{
  ...
  return { data: data ? { ...data, equipment_type: data.equipment_type as EquipmentType, condition: data.condition as EquipmentCondition } as VendorEquipment : null };
}
...
export async function createEquipment(
  ...
  return { data: data ? { ...data, equipment_type: data.equipment_type as EquipmentType, condition: data.condition as EquipmentCondition } as VendorEquipment : undefined };
}
