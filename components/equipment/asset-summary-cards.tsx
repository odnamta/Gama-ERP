  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{formatAssetCurrency(stats.totalBookValue)}</div>
          <p className="text-xs text-muted-foreground">
            Total asset value
          </p>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-red-600">{stats.expiringDocuments}</div>
          <p className="text-xs text-muted-foreground">
            Need attention
          </p>
        </CardContent>
