...
- [x] 1. Database schema setup
  - [x] 1.1 Create migration for preferences JSONB column on user_profiles
    - Add `preferences` JSONB column with default values
    - Include display, notifications, dashboard, and workflow sections
    - _Requirements: 1.1, 1.5_
  - [x] 1.2 Create migration for notification_types table
    ...
    - _Requirements: 1.3_
  - [x] 1.3 Create migration for notification_preferences table
...
- [x] 2. TypeScript types and constants
  - [x] 2.1 Create user preferences types file
...
- [x] 3. Utility functions
  - [x] 3.1 Create user preferences utility functions
  ...
  - [x] 3.4 Write property tests for notification utilities
...
- [x] 5. Server actions
  - [x] 5.1 Create preferences server actions
  ...
  - [x] 5.2 Create notification preferences server actions
  ...
  - [x] 5.3 Write property tests for server actions
...
- [x] 6. Preferences context
  - [x] 6.1 Create preferences context provider
  ...
  - [x] 6.2 Write property test for theme application
...
- [x] 8. Settings page UI components
  - [x] 8.1 Create settings tabs container
    ...
    - _Requirements: 6.1_
  - [x] 8.2 Create display settings tab
  ...
  - [x] 8.3 Create notification settings tab
  ...
  - [x] 8.4 Create notification type row component
  ...
  - [x] 8.5 Create workflow settings tab
...
- [x] 9. Settings page integration
  - [x] 9.1 Create settings page route
  ...
  - [x] 9.2 Write unit tests for settings page
    - Test tab navigation
...
- [x] 10. App integration
  - [x] 10.1 Integrate preferences provider in app layout
    - Wrap app with PreferencesProvider in `app/(main)/layout.tsx`
    - Ensure preferences are loaded on app start
    - _Requirements: 7.1_
  - [x] 10.2 Update navigation to include settings link
